...
$(function () {
    ...
    $tableDerivation=$('#tableConvert').bootstrapTable({
        height:$('#tableConvert').parent().height()-50,
        striped: true,
        clickToSelect:true,
        columns:[
            {
    ...
    $tableApplyItem=$('#tableApple').bootstrapTable({
        height:$('#tableApple').parent().height()-50,
        striped: true,
        clickToSelect:true,
        columns:[
            {
