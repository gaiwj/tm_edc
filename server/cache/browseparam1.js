...
// 浏览参数服务
{
    ...
    var BrowseParamService1 = {
        ...
        get: function (req, getnew) {
            if (getnew || this.bp1.isnull) {
                //var jsonstr = RCookie.get("browseparam1");
                var jsonstr = req.cookies.browseparam1 ? unescape(req.cookies.browseparam1) : "";
        ...
        // 更新缓存到cookie
        update: function (res) {
            res.cookie("usercache", escape(this.bp1.tojson()), {
...
module.exports = BrowseParamService1;